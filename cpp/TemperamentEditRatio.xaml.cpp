...
TemperamentEditRatio::TemperamentEditRatio()
{
	InitializeComponent();
}

void SDKTemplate::TemperamentEditRatio::textBox_TextChanging(Windows::UI::Xaml::Controls::TextBox^ sender, Windows::UI::Xaml::Controls::TextBoxTextChangingEventArgs^ args)
{
